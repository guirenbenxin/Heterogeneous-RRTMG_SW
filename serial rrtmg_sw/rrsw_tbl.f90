...
!------------------------------------------------------------------
      ...
      real(kind=r8) :: inatm_time=0
      real(kind=r8) :: cldprmc_time=0
      real(kind=r8) :: setcoef_time=0
      real(kind=r8) :: spcvmc_time=0
      real(kind=r8) :: input_time=0
      real(kind=r8) :: output_time=0   
